...
class EnrollmentsTest < ApplicationSystemTestCase
  ...
  test "should create enrollment" do
    ...
    fill_in "Date of enrollment", with: @enrollment.date_of_enrollment
    fill_in "Method of contact", with: @enrollment.method_of_contact
    fill_in "Remarks", with: @enrollment.remarks
